...
export const manualSections: ManualSection[] = [
  ...
  },
  {
    ...
    purpose: 'Plant definitions describe the taxon, cultivar, aliases, reference links, type image, and definition-level husbandry for a kind of plant.',
    howTo: [
  ...
  },
  {
    ...
    purpose: 'Plant instances are the actual specimens in a collection. Each instance receives a generated plant ID, status, hierarchical Location, acquisition details, source, notes, photos, bloom records, propagation relationships, sport review, care history, reminders, follows, and a Plant Health Timeline.',
    howTo: [
      ...
      'Filter the instance list by Genus and Species from the linked plant definition, Location with optional child locations, Plant Tag, lifecycle type, and substrate details.',
      'Plant Tag filters are inherited from linked definitions; specimen cards and plant ID previews show a compact inherited tag row.',
  ...
  {
    id: 'substrates',
    title: 'Substrates and Potting History',
    route: '/substrates',
  ...
  },
  {
    ...
    route: '/treatments',
    purpose: 'Treatment Management keeps reusable treatment instructions, physical products, safety requirements, plans, actual applications, and observed outcomes together without replacing product labels or professional guidance.',
    howTo: [
  ...
  {
    id: 'collection-exhibits',
    title: 'Collection Exhibits',
    route: '/exhibits',
    screenshot: 'collection-exhibits.png',
  ...
  },
  {
    ...
    purpose: 'Propagation records connect parent specimens to child specimens and preserve the context for divisions, cuttings, leaves, rhizomes, seed, corm, tissue culture, sport lines, and other propagation methods.',
    howTo: [
  ...
  {
    id: 'collection-tools',
    title: 'Taxonomic Authorities, Collection Tools, and Audit Log',
    route: '/taxonomic-authorities',
    screenshot: 'collection-tools.png',
    purpose: 'Taxonomic Authorities identify the registries, societies, institutions, and agencies responsible for naming or cultivar registration. Structured scope rules let AxilDB match plant definitions consistently.',
    howTo: [
  ...
  },
  {
    ...
    title: 'Collection Activity and Historical Events',
    route: '/activity',
    purpose: 'Collection Activity is the structured, collection-scoped history produced by the Unified Event Engine. Current plant, care, and workflow records remain authoritative; AxilDB is not event-sourced.',
    howTo: [
