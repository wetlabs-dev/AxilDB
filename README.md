...
- Plant instances with generated plant IDs, specimen-specific acquisition labels, acquisition/propagation dates, source/distributor metadata, hierarchical locations, archive status, notes, photos, and irreversible **Pot Together** lifecycle merges. A merge preserves the survivor's ID/QR code, keeps constituent IDs searchable as read-only historical records, aggregates their timelines with origin labels, and carries unresolved operational records forward.
