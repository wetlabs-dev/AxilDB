...
The Acquisition Pipeline is available from **Acquisitions** in the Collection sidebar. It is intentionally definition-centered rather than a separate wishlist table: a Plant Definition can be Researching, Wishlist, Actively Seeking, On Hold, Fulfilled, or No Longer Interested independent of whether the collection already owns specimens. Journal entries, nursery observations, price history, desired location, target prices, and permanent acquisition records stay with the definition. Recording an acquisition can create zero, one, or many Plant Instances with generated plant IDs while preserving the acquisition record as pre-accession provenance. Collection Settings includes acquisition visibility, defaulting to private so public collections do not expose future shopping plans unless a manager explicitly enables it.
