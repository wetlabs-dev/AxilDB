...
- Acquisition Pipeline for pre-accession research and wishlist intent on plant definitions, with priority, target prices, desired size/location, research journal entries, nursery observations, price analytics, and acquisition records that can create one or more Plant Instances.
