...
export async function updateEmailPreferences(fd: FormData) {
  ...
  await prisma.emailPreference.upsert({
    ...
    update: {
      ...
      sunshineNotifications: checkbox(fd, 'sunshineNotifications'),
      collectionUpdateDigestEmailEnabled: checkbox(fd, 'collectionUpdateDigestEmailEnabled'),
      ...
      sunshineNotificationsPushEnabled: checkbox(fd, 'sunshineNotificationsPushEnabled'),
      collectionUpdateDigestPushEnabled: checkbox(fd, 'collectionUpdateDigestPushEnabled'),
