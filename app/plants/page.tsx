      ...
      {canCreate && (
        <AddPanel label={identificationPrefill ? 'Add plant definition from ID My Plant history' : 'Add plant definition'} defaultOpen={Boolean(identificationPrefill)}>
          ...
          <form action={createPlantDefinition} className="grid max-w-6xl gap-x-3 gap-y-2 lg:grid-cols-4">
            ...
            <Field label="Species" help="Required for an identified definition. Use sp. with a named cultivar when the species is unresolved, or leave it blank when a provisional taxon is supplied." name="species" list="definition-species-suggestions" autoCapitalize="none" defaultValue={identificationPrefill?.species || ''} />
