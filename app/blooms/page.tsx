    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-6">
        {blooms.map((bloom) => {
          ...
          return (
            <Link key={bloom.id} href={`/instances/${bloom.plantInstanceId}`} className="group block">
              <Card className="overflow-hidden p-0 transition group-hover:-translate-y-0.5 group-hover:shadow-[0_14px_36px_rgba(47,38,24,0.10)]">
                ...
                <div className="p-3">
                  ...
                  <h3 className="mt-1 text-sm font-bold leading-tight">{bloom.plantInstance.plantId}</h3>
