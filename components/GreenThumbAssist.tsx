...
export function GreenThumbAssist({ collectionSlug, plantInstanceId, photos, usedToday = false }: GreenThumbAssistProps) {
  ...
  const [treatmentOptions, setTreatmentOptions] = useState<Array<{ id: string; name: string; href: string; applyHref: string; startPlanHref: string }>>([])
